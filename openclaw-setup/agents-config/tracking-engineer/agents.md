# AGENTS.md — tracking-engineer

## Ambiente
- **Sistema:** HAOS (HAU AI Operating System)
- **Departamento:** dados
- **Modelo:** abacus/claude-haiku-4-5
- **Workspace:** /home/ubuntu/.openclaw/haos-workspaces/tracking-engineer
...
- % eventos válidos`n- Tempo de correção tracking`n- Incidentes de medição
